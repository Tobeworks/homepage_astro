    ...
    <main id="content-middle">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item">
                                <div class="carousel-block" id="carousel-page1">
                                    ...
                                    <div class="carousel-img">
                                        <img src="src/assets/images/carousel/react.svg" class="img-fluid" alt="app development react logo" />
                                    </div>
                                    ...
                                    <div class="carousel-footer text-center p-2">
                                        <img src="src/assets/images/tech/npm.svg" alt="npm" />
                                        <img src="src/assets/images/tech/react.svg" alt="npm" />
                                        <img src="src/assets/images/tech/js.svg" alt="npm" />
                                    </div>
                            ...
                            <div class="carousel-item active">
                                <div class="carousel-block" id="carousel-page2">
                                    ...
                                    <div class="carousel-img">
                                        <img src="src/assets/images/carousel/gears.svg" class="img-fluid" alt="app development react logo" />
                                    </div>
                                    <div class="carousel-body">
                                        <div class="carousel-flex d-flex justify-content-between">
                                            <div class="p-2 bd-highlight">
                                    ...
                                    <div class="carousel-footer text-center p-2">
                                        <img src="src/assets/images/tech/php.svg" alt="npm" />
                                        <img src="src/assets/images/tech/react.svg" alt="npm" />
                                        <img src="src/assets/images/tech/js.svg" alt="npm" />
                                        <img src="src/assets/images/tech/github.svg" alt="npm" />
                                        <img src="src/assets/images/tech/npm.svg" alt="npm" />
                            ...
                            <div class="carousel-item">
                                <div class="carousel-block" id="carousel-page4">
                                    <div class="carousel-img">
                                        <img src="src/assets/images/carousel/wordpress_stroke.svg" class="img-fluid" alt="Wordpress logo" />
                                    </div>
                                    <div class="carousel-body">
                                        <div class="carousel-flex d-flex justify-content-between">
                                            <div class="p-2 bd-highlight">
                                    ...
                                    <div class="carousel-footer text-center p-2">
                                        <img src="src/assets/images/tech/wordpress.svg" alt="wordpress" />
                                        <img src="src/assets/images/tech/HTML.svg" alt="npm" />
                                        <img src="src/assets/images/tech/CSS.svg" alt="npm" />
                                        <img src="src/assets/images/tech/js.svg" alt="npm" />
                                    </div>
                                </div>
                            ...
                            <div class="carousel-item">
                                <div class="carousel-block" id="carousel-page3">
                                    <div class="carousel-img">
                                        <img src="src/assets/images/carousel/figma.svg" class="img-fluid" alt="webdesign logo" />
                                    </div>
                                    <div class="carousel-body">
                                        <div class="carousel-flex d-flex justify-content-between">
                                            <div class="p-2 bd-highlight">
        ...
        <section class="bg-silver text-erieblack mainsection" id="contentStart">
            <div class="p-2 p-md-5 text-center">
                <img src="src/assets/images/logos/TobeworksLogo.svg" class="img-fluid d-none d-lg-inline" alt="Tobeworks Logo" title="tobeworks Logo" data-aos="fade-up" />
        ...
        <section class="bg-orange text-erieblack cutsection" id="special">
            <div class="row">
                <div class="col-sm-7 align-self-center text-silver" data-aos="fade-right">
                    <div class="cut-left">
